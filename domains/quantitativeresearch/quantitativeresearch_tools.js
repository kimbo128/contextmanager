...
import { z } from "zod";
import { loadSessionStates } from "./quantitativeresearch_index.js";
// Initialize knowledgeGraphManager as null initially
let knowledgeGraphManager = null;
...
async function getKnowledgeGraphManager() {
    if (!knowledgeGraphManager) {
        ...
        try {
            const module = await import("./quantitativeresearch_index.js");
 ...
 */
export function registerQuantitativeResearcherTools(server) {
